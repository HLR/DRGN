...
EMB_PATHS = {
    'transe': '/localscratch/chen.zheng/data/drgn/data/transe/glove.transe.sgd.ent.npy',
    'lm': '/localscratch/chen.zheng/data/drgn/data/transe/glove.transe.sgd.ent.npy',
    'numberbatch': '/localscratch/chen.zheng/data/drgn/data/transe/concept.nb.npy',
    'tzw': '/localscratch/chen.zheng/data/drgn/data/cpnet/tzw.ent.npy',
}
...
def add_data_arguments(parser):
    ...
    parser.add_argument('--inhouse_train_qids', default='/localscratch/chen.zheng/data/drgn/data/{dataset}/inhouse_split_qids.txt', help='qids of the in-house training set')
    # statements
    parser.add_argument('--train_statements', default='/localscratch/chen.zheng/data/drgn/data/{dataset}/statement/train.statement.jsonl')
    parser.add_argument('--dev_statements', default='/localscratch/chen.zheng/data/drgn/data/{dataset}/statement/dev.statement.jsonl')
    parser.add_argument('--test_statements', default='/localscratch/chen.zheng/data/drgn/data/{dataset}/statement/test.statement.jsonl')
