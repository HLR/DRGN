...
### chen: the solution of changing the transformer package cache default dir: https://stackoverflow.com/questions/63312859/how-to-change-huggingface-transformers-default-cache-directory
# import os
# os.environ['TRANSFORMERS_CACHE'] = '/localscratch/chen.zheng/data/transformer_cache/'
...
from modeling.modeling_drgn import *
...
def main():
    ...
    ### chen: the next two args are new args compared to mhgrn
    parser.add_argument('--save_model', dest='save_model', action='store_true')
    parser.add_argument('--load_model_path', default=None)


    # data
    ### mhgrn num_relations are 34. The paper adds 4 relations
    parser.add_argument('--num_relation', default=38, type=int, help='number of relations')
    parser.add_argument('--train_adj', default=f'/localscratch/chen.zheng/data/drgn/data/{args.dataset}/graph/train.graph.adj.pk')
    parser.add_argument('--dev_adj', default=f'/localscratch/chen.zheng/data/drgn/data/{args.dataset}/graph/dev.graph.adj.pk')
    parser.add_argument('--test_adj', default=f'/localscratch/chen.zheng/data/drgn/data/{args.dataset}/graph/test.graph.adj.pk')
    ### chen: the next one arg is new arg compared to mhgrn
    ...
    ### chen: qa_gnn doesn't have cpnet_vocab_path, train_embs, dev_embs, and test_embs
